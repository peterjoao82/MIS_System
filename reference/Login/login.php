...
<html lang="en">
	...
	<body class="login-background">
        ...
        <div class="login-div mt-3 rectangle">
            <div class="logo-div text-center">
                <img src="../Images/smvitm.jpg" alt="" class="align-items-center" width="100" height="100">
            </div>
            <div class="login-padding">
                <h2 class="text-center text-white">LOGIN</h2>
                <form class="p-1" action="login.php" method="POST">
                    <div class="form-group">
                        <label><h6>Enter your USN:</h6></label>
                        <input type="text" name="email" placeholder="Enter USN" class="form-control" required>
                    </div>
                    <div class="form-group">
