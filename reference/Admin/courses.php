...
<?php  
	if (isset($_POST['sub'])) {
		...
		$query="insert into courses(course_code,course_name,semester_or_year) values('$course_code','$course_name','$semester_or_year')";
					...
					<div class="col-md-12 ml-2">
						<section class="mt-3">
							<table class="w-100 table-elements mb-5 table-three-tr" cellpadding="3">
								...
								<?php
									$sr=1;
									$query="select course_code,course_name,semester_or_year from courses";
									$run=mysqli_query($con,$query);
