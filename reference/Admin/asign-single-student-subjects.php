								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select class="browser-default custom-select" name="scheme">
											...
											<?php
												$query="select distinct(scheme) as scheme from course_subjects";
												$run=mysqli_query($con,$query);
												while($row=mysqli_fetch_array($run)) {
							...
							<table class="w-100 table-elements table-three-tr" cellpadding="3">
								...
								<?php  
									...
									if (isset($_POST['submit'])) {
										...
										$scheme=$_POST['scheme'];
										$que="select * from course_subjects where course_subjects.course_code='$course_code' and course_subjects.scheme='$scheme' ";
                                        $run=mysqli_query($con,$que);
                                        while ($row=mysqli_fetch_array($run)) {
                                            $count++;
                                ?>
