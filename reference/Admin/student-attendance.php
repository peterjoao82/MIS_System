...
if (isset($_POST['sub'])) {
	...
	for ($i=0; $i < $count; $i++) {  
		$date=date("d-m-y");
		$que="insert into student_attendance(course_code,subject_code,semester,student_id,attendance)values('".$_POST['course_code'][$i]."','".$_POST['subject_code'][$i]."','".$_POST['semester'][$i]."','".$_POST['roll_no'][$i]."','".$_POST['atten'][$i]."')";
					...
					<div class="col-md-12">
						<section class="border mt-3">
							<table class="w-100 table-elements table-three-tr" cellpadding="3">
								...
								$i=1;
								$count=0;
									$conn=mysqli_connect("localhost","root","","smvitm");
									...
									?>
										...
										<tr>
											...
											<td><input type="text" name="atten[]" placeholder="Plz Enter Final Attendance" class="form-control"></td>  
