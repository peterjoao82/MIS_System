							...
							<table class="w-100 table-elements table-three-tr" cellpadding="3">
								...
								$count=0;
									if (isset($_POST['submit'])) {
										...
										$que="select student_info.roll_no,first_name,student_courses.semester, student_courses.course_code,subject_code from student_courses inner join student_info on student_info.roll_no=student_courses.roll_no where student_courses.course_code='$course_code' and student_courses.roll_no='$roll_no'";
									$run=mysqli_query($con,$que);
									while ($row=mysqli_fetch_array($run)) {
										$count++;
									?>
