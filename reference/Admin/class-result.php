...
<?php
	...
	if (isset($_POST['sub'])) {
		...
		for ($i=0; $i < $count; $i++) { 
			$date=date("d-m-y");
			$que="insert into class_result(roll_no,course_code,subject_code,semester,IA1,IA2,IA3,total_marks,obtain_marks)values('".$_POST['roll_no'][$i]."','".$_POST['course_code'][$i]."','".$_POST['subject_code'][$i]."','".$_POST['semester'][$i]."','".$_POST['IA1'][$i]."','".$_POST['IA2'][$i]."','".$_POST['IA3'][$i]."','".$_POST['total_marks'][$i]."','".$_POST['obtain_marks'][$i]."')";
	...
	<!-- title of this page -->
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100">
			<div class="sub-main">
				...
				<?php
                                    echo "<td width='30'><a class='btn btn-primary' href=update_result.php?>Update</a></td>";
					...
					<div class="col-md-12">
						...
						<form action="class-result.php" method="post">
							<div class="row mt-3">
								...
								<div class="col-md-4">
									<input type="submit" name="submit" class="btn btn-primary px-4" value="Press">
</div>
								...
								$count=0;
									...
									?>
										...
										<tr>
											...
											<td><input type="text" name="IA1[]" placeholder="Plz Enter Obtain Marks" class="form-control"></td>
											
											<td><input type="text" name="IA2[]" placeholder="Plz Enter Obtain Marks" class="form-control"></td>
											
											<td><input type="text" name="IA3[]" placeholder="Plz Enter Obtain Marks" class="form-control"></td>
											
									
											<td class="text-center"><?php echo "40" ?></td>
											<input type="hidden" name="total_marks[]" value="40" >
											<td><input type="text" name="obtain_marks[]" placeholder="Plz Enter Final Marks" class="form-control"></td>
