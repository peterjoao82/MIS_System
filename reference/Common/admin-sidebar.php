    ...
    <nav id="sidebarMenu" class="">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../admin/time-table.php">
              <span data-feather="layers"></span>
               <i class="fa fa-clock-o mr-2" aria-hidden="true"></i> Timetable
            </a>
		  </li>
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
            <a class="nav-link" href="../admin/inc_sem.php">
              <span data-feather="layers"></span>
              <i class="fa fa-check-square-o mr-2" aria-hidden="true"></i> Advance Semester
            </a>
          </li>
          <li class="nav-item">
