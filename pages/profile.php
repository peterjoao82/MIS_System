...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="../assets/img/sm.jpg">
  <link rel="icon" type="image/png" href="../assets/img/sm.jpg">
  <title>
    Profile - MIS
  </title>
  <!--     Fonts and icons     -->
...
<body class="g-sidenav-show bg-gray-100">
  ...
  <!-- <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
        ...
        <span class="ms-1 font-weight-bold">MIS SYSTEM | SMVITM</span>
      </a>
    </div> -->
          ...
          <!-- <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3"> -->
            <!-- <div class="nav-wrapper position-relative end-0"> -->
              <!-- <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist"> -->
                ...
                <!-- <div class="col-md-6 pr-5">
									<div class="form-group">
										<label for="exampleInputPassword1">Faculty Advisor</label>
										<input type="text" name="semester" class="form-control"  placeholder="Semester" value=<?php echo $row['fac_adv'] ?> readonly>
									</div>
								</div> -->
							</div>
							<?php } ?>
