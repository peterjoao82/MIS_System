                  ...
                  <?php 
                            ...
                            $obtain_marks=0;
                             ...
                             //  $roll_no=$_SESSION['user_id'];
                                $query="SELECT m.ST_NO,m.SUB_CODE ,s.SUB_NAME,s.SEMESTER, AVG(m.IA_1+m.IA_2+m.IA_3) as mm FROM marks m, subject s WHERE m.SUB_CODE=s.SUB_CODE AND m.ST_NO='4MW20CS001' GROUP by s.SUB_CODE";
